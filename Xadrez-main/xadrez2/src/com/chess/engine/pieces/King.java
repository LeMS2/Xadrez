   ...
   public King(final Alliance pieceAlliance, int piecePosition) {
    ...
    public Collection<Move> calculateLegalMoves(Board board) {
        ...
        for(final int currentCandidateOffset : CANDIDATE_MOVE_COORDINATE){
           final int candidatesDestinationCoordinate = this.piecePosition + currentCandidateOffset;
           ...
           if(BoardUtils.isValidTileCoordinate(candidatesDestinationCoordinate)){
               final Tile candidateDestinationTile = board.getTile(candidatesDestinationCoordinate);
